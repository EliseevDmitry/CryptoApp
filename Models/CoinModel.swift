...
/*
 ...
 key: CG-gRUe27TD1XkyacbHoV4S4XLs
 
 запрос на аутентификацию: https://api.coingecko.com/api/v3/ping?x_cg_demo_api_key=CG-gRUe27TD1XkyacbHoV4S4XLs
 www: https://www.coingecko.com/
 сервис создания модели данных JSON - https://app.quicktype.io/
